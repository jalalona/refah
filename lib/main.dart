...
class _MyAppState extends State<MyApp> {
  ...
  static String name = 'رفاه اندیشان';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: "رفاه اندیشان"),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future delay(BuildContext context) async {
    await new Future.delayed(new Duration(milliseconds: 3000), () {
      ...
      Navigator.of(context)
          .push(MaterialPageRoute(builder: (context) => LoginHome()));
    });
  }
  ...
  Future<void> initState() {
    ...
    var signalr = SignalR(context);
    signalr.setNotificationObject(flutterLocalNotificationsPlugin);
  }
  ...
  Widget build(BuildContext context) {
    delay(context);
    return Scaffold(
      backgroundColor: ColorAsset.base,
      //body: LoginHome(),
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            InkWell(
              ...
              onTap: () async {
                //await _showNote();
                await _showNotification("32424", "43674626");
              },
            ),
          ],
        ),
  ...
  Future<void> _showNotification(String _title, String _message) async {
    ...
    await flutterLocalNotificationsPlugin
        .show(0, _title, _message, platformChannelSpecifics, payload: 'item x');
  }
